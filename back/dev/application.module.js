...
const get_1 = require("./routes/cvs/get");
const put_1 = require("./routes/cvs/put");
const delete_1 = require("./routes/cvs/delete");
const post_1 = require("./routes/cvs/post");
...
const cvsDocumentServiceFactory = (mongoClientService) => new services_1.CvsDocumentService(mongoClientService);
...
ApplicationModule = __decorate([
    core_1.HapinessModule({
        ...
        declarations: [
            get_1.GetOneCvRoute,
            get_1.GetAllCvsRoute,
            put_1.PutUpdateCvRoute,
            delete_1.DeleteOneCvRoute,
            post_1.PostCreateCvRoute
        ],
        providers: [
            core_1.HttpServerService,
            services_1.CvsService,
            { provide: services_1.CvsDocumentService, useFactory: cvsDocumentServiceFactory, deps: [mongo_1.MongoClientService] }
        ]
    }),
