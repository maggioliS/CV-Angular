...
class MongoClientExt {
    ...
    storeDocuments(module) {
        return rxjs_1.Observable
            ...
            .map(_ => ({
            metadata: _,
            adapter: this._mongoManager.getAdapter(instanceToken.instance.connectionOptions.adapter, instanceToken.instance.connectionOptions.options)
        }))
    ...
    onShutdown() {
        ...
        const exitObservable = rxjs_1.Observable
            .from(adapters)
