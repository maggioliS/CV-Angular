...
class HapinessMongoAdapter extends events_1.EventEmitter {
    ...
    tryConnect() {
        __debugger.debug('tryConnect', `connecting to ${shared_1.UtilFunctions.hideCredentials(this._uri)}`);
    ...
    onDisconnected() {
        __debugger.debug('onDisconnected', `disconnected from ${shared_1.UtilFunctions.hideCredentials(this._uri)}`);
