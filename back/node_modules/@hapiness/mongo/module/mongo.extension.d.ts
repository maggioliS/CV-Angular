import { CoreModule, Extension, ExtensionWithConfig, OnExtensionLoad, OnModuleInstantiated, OnShutdown, ExtensionShutdown } from '@hapiness/core';
...
export declare class MongoClientExt implements OnExtensionLoad, OnModuleInstantiated, OnShutdown {
    private _mongoManager;
